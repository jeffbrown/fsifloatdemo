			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="volume" title="${message(code: 'bottle.volume.label', default: 'Volume')}" />
				...
				<g:each in="${bottleInstanceList}" status="i" var="bottleInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${bottleInstance.id}">${fieldValue(bean: bottleInstance, field: "volume")}</g:link></td>
